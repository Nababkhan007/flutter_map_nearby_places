...
import 'package:mapnearbyplaces/services/map_services.dart';
import 'package:mapnearbyplaces/providers/search_places.dart';
import 'package:google_maps_flutter/google_maps_flutter.dart';
import 'package:flutter_rating_stars/flutter_rating_stars.dart';
import 'package:mapnearbyplaces/models/auto_complete_result.dart';
...
//Markers set
  ...
  _setNearMarker(LatLng point, String label, List types, String status) async {
    ...
    if (types.contains('restaurants')) {
      markerIcon = await getBytesFromAsset('assets/icons/restaurants.png', 75);
    } else if (types.contains('food')) {
      markerIcon = await getBytesFromAsset('assets/icons/food.png', 75);
    } else if (types.contains('school')) {
      markerIcon = await getBytesFromAsset('assets/icons/schools.png', 75);
    } else if (types.contains('bar')) {
      markerIcon = await getBytesFromAsset('assets/icons/bars.png', 75);
    } else if (types.contains('lodging')) {
      markerIcon = await getBytesFromAsset('assets/icons/hotels.png', 75);
    } else if (types.contains('store')) {
      markerIcon =
          await getBytesFromAsset('assets/icons/retail-stores.png', 75);
    } else if (types.contains('locality')) {
      markerIcon =
          await getBytesFromAsset('assets/icons/local-services.png', 75);
    } else {
      markerIcon = await getBytesFromAsset('assets/icons/places.png', 75);
    }
            ...
            decoration: BoxDecoration(
              ...
              image: DecorationImage(
                  image: NetworkImage(
                    ...
                    "&photo_reference=$placeImg&key=$key",
                  ),
                  fit: BoxFit.cover),
            ),
          ),
