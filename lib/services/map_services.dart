...
class MapServices {
  ...
  Future<List<AutoCompleteResult>> searchPlaces(String searchInput) async {
    final String url =
        ...
        "json?input=$searchInput&types=$types&key=$key";
  ...
  Future<Map<String, dynamic>> getDirections(
    ...
    final String url = "https://maps.googleapis.com/maps/api/directions/"
        "json?origin=$origin&destination=$destination&key=$key";
  ...
  Future<dynamic> getPlaceDetails(LatLng coordinates, int radius) async {
    var lat = coordinates.latitude;
    var lng = coordinates.longitude;

    final String url =
        "https://maps.googleapis.com/maps/api/place/nearbysearch/"
        "json?&location=$lat,$lng&radius=$radius&key=$key";
